  ...
  uploadImage = async(uri_data) => {
    ...
    try {
      await axios.post("http://"+LocalIP+":3500/main/upload",data, {
        ...
        const url="http://"+LocalIP+":1111/damage_level"
        ...
        await axios.post(url,data,{
          headers: { "Content-Type": "application/json" }
            ...
            this.props.navigation.navigate("Results",{ result: res.data.result,resultMain: res.data.result, resultTxt: res.data.text_data })
        })
      }).catch(error => {
        console.log(error);
      })
